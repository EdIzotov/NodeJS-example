...
function requests(resolve) {
    let amount = parseFloat(process.env["600_amount3"]);
    let keyId = process.env["600_keyId3"];
    let trxAmount = parseFloat(process.env["600_trxAmount"]);
    let account = JSON.parse(process.env["600_non_ahg_account3"]);

    async.waterfall(
        [
            done => {
                logger.info("Request: block non-AHG account");
                ...
                logger.info(
                    "Request: get balance, for blocked account operation should not be successful"
                );
                ...
                logger.info(
                    "Request: perform transaction, for blocked account operation should not be successful"
                );
                ...
                logger.info(
                    "Request: get history, for blocked account operation should not be successful"
                );
                ...
                logger.info("Request: unblock non-AHG account");
                ...
                logger.info(
                    "Request: balance to verify that the account was unblocked successfully"
                );
