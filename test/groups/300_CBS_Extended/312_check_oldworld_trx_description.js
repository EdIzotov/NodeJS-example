...
function requests(resolve) {
    ...
    async.waterfall(
        [
                ...
                logger.info("Request: CBS oldWord refill");

                cbsApi["oldWorld"].refillAmount(account1, data, function(
                    err,
                    res
                ) {
                    if (err) {
                ...
                logger.info("Request: SAP history");
                ...
                logger.info("Request: SAP trx status");
