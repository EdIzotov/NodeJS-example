...
function requests(resolve) {
    ...
    logger.info(
        "Request: SAP operations(balance,trx,history) with incorrect uuid."
    );

    var data = [
        SAP_DATA[TYPES.BALANCE]({
            id: "66356cef-5c45-4749-bb58-e03e1f0d00mm", // incorrect uuid
        ...
        SAP_DATA[TYPES.HISTORY]({
            id: "66356cef-5c45-4749-bb58-e03e1f0d00mm\n",
            yourIdentityIOVAddress: account1.identity.iovMasterChainId,
            privKey: privKey,
            yourWalletAccountNumber: account1.iovSideChainId,
            from: new Date(
